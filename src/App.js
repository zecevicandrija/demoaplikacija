    ...
    <>
      <div>
        ...
        <Switch>
          ...
          <Route path="/loginovan">{user && <Registrovanikorisnik />}</Route>
          <Route path="/usluge">{user && <Usluga />}</Route>
          <Route path="/pauza">{user && <Pauza />}</Route>
          <Route path="/Novausluga">{user && <Novausluga />}</Route>
          <Route path="/Editusluge">{user && <Editusluga />}</Route>
          <Route path="/Novifrizer">{user && <Novifrizer />}</Route>
          <Route path="/Editfrizera">{user && <Editfrizera />}</Route>
          <Route path="/Radnovreme">{user && <RadnoVreme />}</Route>
          <Route path="/Kategorija">{user && <Kategorijausluge />}</Route>

          <Route path="/Statistika">{user && <Statistika />}</Route>
          ...
          <Route path="/Podacikorisnika">{user && <Podacikorisnika />}</Route>
          <Route path="/Detaljitermina">{user && <Detaljitermina />}</Route>
          <Route path="/Klijenti">{user && <Klijenti />}</Route>
          <Route path="/">
            {user ? <Redirect to="/loginovan" /> : <Redirect to="/login" />}
          </Route>
        </Switch>
      </div>
    </>
